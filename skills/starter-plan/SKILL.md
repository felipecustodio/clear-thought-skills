...
starter-plan acts as an automated starter orchestration skill for the primary agent loop: PLAN. It ensures disciplined execution of reasoning frameworks throughout this critical phase.
...
3. **Map System Architecture (`systems-thinking`)**: Identify component interconnections, feedback loops, and leverage points.
